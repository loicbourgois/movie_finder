...
q AS (
    SELECT
        ...
        media___publication_date.publication_date
    FROM media
    ...
    WHERE
        media.language = 'en'
        AND (
            media___director.language = 'en'
            OR media___director.language IS null
        )
        AND (
            media___creator.language = 'en' OR media___creator.language IS null
        )
        AND (
            director___gender.language = 'en'
            OR director___gender.language IS null
        )
)
